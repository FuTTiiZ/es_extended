...
TriggerEvent('es:addGroupCommand', 'setmoney', 'admin', function(source, args, user)
	...
	if target and money_type and money_amount and xPlayer ~= nil then
		if money_type == 'cash' then
			...
			TriggerEvent('DiscordBot:ToDiscord', 'admin', 'Admin Command', GetPlayerName(_source).. ' spawnede DKK: ' ..money_amount.. ' til '..xPlayer.name, 'system', _source, false, false)
		...
		elseif money_type == 'black' then
			...
			TriggerEvent('DiscordBot:ToDiscord', 'admin', 'Admin Command', GetPlayerName(_source).. ' spawnede Black: ' ..money_amount.. ' til '..xPlayer.name, 'system', _source, false, false)
		else
...
TriggerEvent('es:addGroupCommand', 'giveaccountmoney', 'admin', function(source, args, user)
	...
	if amount ~= nil then
		if xPlayer.getAccount(account) ~= nil then
			...
			TriggerEvent('DiscordBot:ToDiscord', 'admin', 'Admin Command', GetPlayerName(_source).. ' spawnede account: ' ..amount.. ' til '..xPlayer.name, 'system', _source, false, false)
		else
